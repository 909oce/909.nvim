...
hl(0, "NoiceConfirmBorder", { link = "Normal" })
hl(0, "Title", { link = "Normal" })
hl(0, "NoiceAttr68", { link = "Normal" })
hl(0, "DiagnosticVirtualTextWarn", { fg = get("DiagnosticWarn", true).foreground, bg = "#3B2A2F" })
hl(0, "DiagnosticVirtualTextError", { fg = get("DiagnosticError", true).foreground, bg = "#441D18" })
hl(0, "DiagnosticVirtualTextInfo", { fg = get("DiagnosticInfo", true).foreground, bg = "#2C3728" })
